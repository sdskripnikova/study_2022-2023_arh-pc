...
![Вывела результат](image/Снимок экрана от 2022-12-03 22-58-15.png){ #fig:006 width=70% }
...
1. Я написала программу, которая находит наименьшее из 3 целочисленных переменных. (рис. [-@fig:014]; рис. [-@fig:015]; рис. [-@fig:016]; рис. [-@fig:017])

![Текст программы](Снимок лаб8.ср1.1.PNG){ #fig:014 width=70% }
![Текст программы](image/Снимок лаб8.ср1.2.PNG){ #fig:015 width=70% }
![Текст программы](image/Снимок лаб8.ср1.3.PNG){ #fig:016 width=70% }
![Результат](image/Снимок лаб8.ср1.PNG){ #fig:017 width=70% }

2. Я написала программу, которая для введенных с клавиатуры значений вычислит значение заданной функции №6. (рис. [-@fig:018]; рис. [-@fig:019]; рис. [-@fig:020]; рис. [-@fig:021] ; рис. [-@fig:022])

![Текст программы](image/Снимок лаб8.ср2.2.PNG){ #fig:018 width=70% }
![Текст программы](image/Снимок лаб8.ср2.3.PNG){ #fig:019 width=70% }
![Текст программы](image/Снимок лаб8.ср2.4.PNG){ #fig:020 width=70% }
![Результат](image/Снимок лаб8.ср2.1.PNG){ #fig:021 width=70% }
![Результат](image/Снимок лаб8.ср2.PNG){ #fig:022 width=70% }
